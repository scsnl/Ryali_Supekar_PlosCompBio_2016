function model = vb_cont_hmm_multi_subj(data,K,maxIter,tol, no_repetitions,task,init_option)
...
lambdai = 10^5; %precisionm - large value to force emission posterior means to zero; small values - non-informative
